export default function PrivacyPolicy() {
  return (
    <div style={{
      ...
      <p>
        This Privacy Policy governs the use of the mobile game <strong>Bubble Tapper</strong> (hereby referred to as "Application") developed by <strong>Alpha Code Labs</strong> (hereby referred to as "Service Provider"). This Application is provided as a free game and is intended for use "AS IS."
      </p>
