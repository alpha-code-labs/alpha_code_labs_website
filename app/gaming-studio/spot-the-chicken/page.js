...
import spotTheChicken_vid from "@/assets/videos/spotTheChicken.mp4";
...
const GameOne = () => {
  ...
  const handleSubmitForm = (e) => {
    ...
    fetch(sheetURL, {
      ...
      body: `Name=${formData.name}&Email=${formData.email}&Date=${formData.date}&Game=${"SPOT-THE-CHICKEN"}`,
    })
            ...
            >
              ...
              >
                ...
                <Typography variant="body1" 
                                              sx={{ fontSize: "24px", textAlign: "center",fontFamily: "Arial, sans-serif", fontWeight: "bold", pb:"8px", color: "black" }}>


A cluckin' good time awaits!
                </Typography>
                                              <Typography variant="body1" 
                                              sx={{ fontSize: "16px", textAlign: "center",fontFamily: "Arial, sans-serif", fontWeight: "bold", color: "black" }}>


Think you’ve got sharp eyes and fast reflexes?
Put your skills to the test in the most egg-citing game of hide-and-seek ever hatched!
                </Typography>
