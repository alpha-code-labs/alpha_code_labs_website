...
const GameOne = () => {
  ...
  const handleSubmitForm = (e) => {
    ...
    fetch(sheetURL, {
      ...
      body: `Name=${formData.name}&Email=${formData.email}&Date=${formData.date}&Game=${"DIVINE-QUEST-2"}`,
    })
