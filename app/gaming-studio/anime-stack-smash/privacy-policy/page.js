export default function PrivacyPolicy() {
    return (
      <div style={{
        ...
        <p>
          This Privacy Policy governs the use of the mobile game <strong>Anime Stack Smash</strong> (hereby referred to as "Application") developed by <strong>Alpha Code Labs</strong> (hereby referred to as "Service Provider"). This Application is provided as a free game and is intended for use "AS IS."
        </p>
  
        <h2>1. No Data Collection</h2>
        <p>
          Anime Stack Smash does not collect, store, or share any personal data from its users. The game does not require users to create accounts, provide personal information (such as name, email address, or phone number), or grant access to device features beyond what is required for normal gameplay.
        </p>
